...
itemlist.clammingItems = {
    ...
    { item = "Coral fragment",            weight = 6,  npc_gil = 1735,  ah_gil = 3000,  sell_to = "AH"    },
    { item = "Quality crab shell",        weight = 6,  npc_gil = 3312,  ah_gil = 4000,  sell_to = "NPC"   },
    { item = "Crab shell",                weight = 6,  npc_gil = 392,   ah_gil = 300,   sell_to = "NPC"   },
    { item = "Elm log",                   weight = 6,  npc_gil = 390,   ah_gil = 3000,  sell_to = "AH"    },
    ...
    { item = "Lacquer tree log",          weight = 6,  npc_gil = 3578,  ah_gil = 5000,  sell_to = "AH"    },
    { item = "Maple log",                 weight = 6,  npc_gil = 15,    ah_gil = 50,    sell_to = "NPC"   },
    ...
    { item = "Petrified log",             weight = 6,  npc_gil = 2193,  ah_gil = 3000,  sell_to = "AH"    },
